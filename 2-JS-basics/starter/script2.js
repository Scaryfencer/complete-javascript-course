...
//     // Use RETURN in order to make a specific result of the function available outside
//     // the function
...
// // Function declaration do not produce an immediate result
...
// console.log(whatDoYouDo('cop', 'Joey'));
...
// METHODS. Predefined actions or functions that can be called on a variable or array
john.push('blue');
john.unshift('Mr.');
console.log(john);
...
// Searching for a specific item in an array, and then using ternary operation to inform us of result
var isDesignerTest = john.indexOf('designer') === -1 ? 'John in NOT a desginer.' : 'John IS a designer';
console.log(isDesignerTest);